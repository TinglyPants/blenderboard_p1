...
export default function SearchBar(){
    ...
    return <div className="flex bg-lightest p-5 mx-[2rem] items-center text-white rounded-full w-full">
        <input className="bg-lightest w-full focus:outline-none" /> { /* Input for search text*/}
        <SvgIcon 
